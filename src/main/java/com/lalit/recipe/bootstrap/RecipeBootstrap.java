package com.lalit.recipe.bootstrap;

import com.lalit.recipe.domain.*;
import com.lalit.recipe.repositories.CategoryRepository;
import com.lalit.recipe.repositories.RecipeRepository;
import com.lalit.recipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredients(new Ingredient("fresh lime or lemon juice", new BigDecimal(2), tableSpoonUom));
